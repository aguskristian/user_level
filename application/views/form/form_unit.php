...
<div class="container">
	...
	<div class="eleven columns">
		<h4 class="headline">Form Input Unit</h4>
		...
		<div id="contact-form">
            <form accept-charset="UTF-8" class="new_message" id="new_message" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="4/e/8HmCN84QvWqbOVWyVzVjaeK9ql3IzLWgVc6HSSQ=" /></div>
				...
				<div class="field">
                    ...
                    <input id="message_name" name="vu_code" size="30" type="text" />
				</div>
				<div class="field">
					<label>Unit Name</label>
                    <input id="message_name" name="vu_name" size="30" type="text" />
				</div>
				<div class="field">
					<label>Kode Station</label>
                    <input id="message_name" name="vu_vs_code" size="30" type="text" />
				</div>
				<div class="field">
					<label>Level Station</label>
                    <input id="message_name" name="vu_level" size="30" type="text" />
				</div>
				<div class="field">
