...
<div class="container">
	...
	<div class="eleven columns">
		<h4 class="headline">Form Input Team</h4>
		...
		<div id="contact-form">
            <form accept-charset="UTF-8" class="new_message" id="new_message" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="4/e/8HmCN84QvWqbOVWyVzVjaeK9ql3IzLWgVc6HSSQ=" /></div>
                    ...
                    <input id="message_name" name="vt_code" size="30" type="text" />
				</div>
			
				<div>
					<label>Team Name</label>
                    <input id="message_name" name="vt_name" size="10" type="text" />
				</div>
				
				<div class="field">
					<label>Sub Unit Team</label>
                    <input id="message_name" name="vt_vsu_code" size="30" type="text" />
				</div>
				
				<div>
					<label>Team Level</label>
                    <input id="message_name" name="vt_level" size="10" type="text" />
				</div>
